...
## 🚀 Funcionalidades
*   **Sistema de Autenticação:** Cadastro, Login e Logout de usuários com sessões seguras.
*   **Privacidade de Dados:** Cada usuário logado tem acesso apenas à sua própria lista de contatos.
*   **Operações CRUD:** Criação, leitura, atualização e exclusão de contatos.
*   **Interface Responsiva:** Layout adaptável para celulares e computadores.
